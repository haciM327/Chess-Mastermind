...
def draw_board(move_type, square, cmove):
    ...
    if sys.platform == "win32":
        ...
        if move_type == "Mistake!":
            img = pygame.image.load("/usr/local/share/chess-mastermind/img/mistake.png")
        if move_type == "Inaccuracy!":
            img = pygame.image.load("/usr/local/share/chess-mastermind/img/innacuracy.png")
        if move_type == "Blunderous Move!":
            img = pygame.image.load("/usr/local/share/chess-mastermind/img/blunder.png")
        if move_type == "Good Move!":
            img = pygame.image.load("/usr/local/share/chess-mastermind/img/good.png")
        if move_type == "Excellent Move!":
            img = pygame.image.load("/usr/local/share/chess-mastermind/img/excellent.png")
        if move_type == "Best Move!":
            img = pygame.image.load("/usr/local/share/chess-mastermind/img/best.png")
        if move_type == "Great Move!":
            img = pygame.image.load("/usr/local/share/chess-mastermind/img/great.png")
        if move_type == "Brilliant Move!!":
            img = pygame.image.load("/usr/local/share/chess-mastermind/img/brilliant.png")
...
def setup_game(headers):
    ...
    if sys.platform == "win32":
        ...
        piece_list = [pieces.piece("r", ["A", "1"], (7.5, 27.5+(75*7)), "/usr/local/share/chess-mastermind/img/white_rook.png"),
                    ...
                    pieces.piece("b", ["C", "1"], (7.5+(75*2), 27.5+(75*7)), "/usr/local/share/chess-mastermind/img/white_bishop.png"),
                    pieces.piece("q", ["D", "1"], (7.5+(75*3), 27.5+(75*7)), "/usr/local/share/chess-mastermind/img/white_queen.png"),
                    pieces.piece("k", ["E", "1"], (7.5+(75*4), 27.5+(75*7)), "/usr/local/share/chess-mastermind/img/white_king.png"),
                    pieces.piece("b", ["F", "1"], (7.5+(75*5), 27.5+(75*7)), "/usr/local/share/chess-mastermind/img/white_bishop.png"),
                    pieces.piece("n", ["G", "1"], (7.5+(75*6), 27.5+(75*7)), "/usr/local/share/chess-mastermind/img/white_knight.png"),
                    pieces.piece("r", ["H", "1"], (7.5+(75*7), 27.5+(75*7)), "/usr/local/share/chess-mastermind/img/white_rook.png"),
                    pieces.piece("R", ["A", "8"], (7.5+(75*0), 27.5+(75*0)), "/usr/local/share/chess-mastermind/img/black_rook.png"),
                    pieces.piece("N", ["B", "8"], (7.5+(75*1), 27.5+(75*0)), "/usr/local/share/chess-mastermind/img/black_knight.png"),
                    pieces.piece("B", ["C", "8"], (7.5+(75*2), 27.5+(75*0)), "/usr/local/share/chess-mastermind/img/black_bishop.png"),
                    pieces.piece("Q", ["D", "8"], (7.5+(75*3), 27.5+(75*0)), "/usr/local/share/chess-mastermind/img/black_queen.png"),
                    pieces.piece("K", ["E", "8"], (7.5+(75*4), 27.5+(75*0)), "/usr/local/share/chess-mastermind/img/black_king.png"),
                    pieces.piece("B", ["F", "8"], (7.5+(75*5), 27.5+(75*0)), "/usr/local/share/chess-mastermind/img/black_bishop.png"),
                    pieces.piece("N", ["G", "8"], (7.5+(75*6), 27.5+(75*0)), "/usr/local/share/chess-mastermind/img/black_knight.png"),
                    pieces.piece("R", ["H", "8"], (7.5+(75*7), 27.5+(75*0)), "/usr/local/share/chess-mastermind/img/black_rook.png")]
    ...
    if sys.platform == "win32":
        ...
        for i in range(8):
            piece_list.append(pieces.piece("P", [key[i], "7"], (7.5+(75*i), 27.5+(75*1)), "/usr/local/share/chess-mastermind/img/black_pawn.png"))
